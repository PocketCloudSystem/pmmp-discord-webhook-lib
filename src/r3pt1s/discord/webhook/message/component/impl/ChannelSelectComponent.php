...
final class ChannelSelectComponent extends CustomComponent implements ActionRowChildComponent {
    ...
    public function addDefaultValue(string $channelId): self {
        $this->defaultValues[] = SelectDefaultValue::create($channelId, DefaultValueRepresentationType::CHANNEL);
        return $this;
    }
