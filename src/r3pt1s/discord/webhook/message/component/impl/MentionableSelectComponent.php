...
final class MentionableSelectComponent extends CustomComponent implements ActionRowChildComponent {
    ...
    public function addDefaultValue(string $id, DefaultValueRepresentationType $type): self {
        $this->defaultValues[] = SelectDefaultValue::create($id, $type);
        return $this;
    }
